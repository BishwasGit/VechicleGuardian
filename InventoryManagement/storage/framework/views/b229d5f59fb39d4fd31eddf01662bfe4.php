...
<?php echo $__env->make('repairpartseller.partials.scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="nk-schedule-item-inner">
                    ...
                    <div class="nk-schedule-content"><span class="smaller">2:12 PM</span>
                        ...
                        <ul class="d-flex flex-wrap gap g-2 py-2">
                            <li>
                                <div class="media media-xxl"><img src="#" alt="" class="img-thumbnail"></div>
                            </li>
                            <li>
                                <div class="media media-xxl"><img src="#" alt="" class="img-thumbnail"></div>
                            </li>
...
<?php /**PATH D:\VG\VechicleGuardian\InventoryManagement\resources\views/repairpartseller/partials/footer.blade.php ENDPATH**/ ?>