                                                ...
                                                <table class="datatable-init table dataTable-table"
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $inventories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td class="tb-col"><?php echo e($item->item_id); ?></td>
                                                                <td class="tb-col">
                                                                    <div class="media-group">
                                                                        <div class="media media-md media-middle"><img
                                                                                src="<?php echo e($item->item_image); ?>"
                                                                                alt="<?php echo e($item->item_id); ?>"></div>
                                                                        <div class="media-text"><a href="#"
                                                                                class="title"><?php echo e($item->item_name); ?></a>
                                                                            <div class="text smaller d-none d-sm-block">
                                                                                <?php echo e($item->item_description); ?></div>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="tb-col">
                                                                    <?php if($item->item_quantity < 5): ?>
                                                                        <span class="btn btn-sm btn-icon bg-warning-soft"><?php echo e($item->item_quantity); ?></span> <!-- Mark quantity as low stock -->
                                                                    <?php elseif($item->item_quantity == 0): ?>
                                                                        <span class="btn btn-sm btn-icon bg-danger-soft">Out of Stock</span> <!-- Mark item as out of stock -->
                                                                    <?php else: ?>
                                                                    <span class="btn btn-sm btn-icon bg-success-soft"> <?php echo e($item->item_quantity); ?></span>
                                                                    <?php endif; ?>
                                                                </td>
                                                                <td class="tb-col"><?php echo e($item->item_price); ?></td>
                                                                ...
                                                                <td class="tb-col tb-col-end">
                                                                    <div class="d-flex justify-content-end gap g-2">
                                                                        <div class="gap-col"><a type="button"
                                                                                ...
                                                                                title="Print"
                                                                                href="<?php echo e(route('repairpartseller.inventories.inventories.edit', ['id' => $item->item_id])); ?>"><em
                                                                                    class="icon ni ni-edit"></em></a>
                                                                        </div>
                                                                        <div class="gap-col"><a
                                                                                href="<?php echo e(route('repairpartseller.inventories.inventories.show', ['id' => $item->item_id])); ?>"
        ...
        $('.delete-item').on('click', function(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'DELETE',
                        url: "<?php echo e(route('repairpartseller.inventories.inventories.destroy', ':id')); ?>"
                            .replace(':id', itemId),
                        headers: {
...
<?php echo $__env->make('repairpartseller.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\VG\VechicleGuardian\InventoryManagement\resources\views/repairpartseller/inventories/index.blade.php ENDPATH**/ ?>