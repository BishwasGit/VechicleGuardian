      ...
      <div class="wide-xs mx-auto">
            ...
            <div class="row g-2">
              <div class="col-sm-6">
                <a href="#" class="btn btn-outline-light w-100"
                  ><img
                    src="<?php echo e(asset('assets/images/icon/d.png')); ?>"
                    alt=""
                    class="icon"
              ...
              <div class="col-sm-6">
                <a href="#" class="btn btn-outline-light w-100"
                  ><img
                    src="<?php echo e(asset('assets/images/icon/b.png')); ?>"
                    alt=""
                    class="icon"
        ...
        <div class="text-center mt-5">
          <p class="small">
            ...
            <a href="<?php echo e(route('main.register')); ?>">Register</a>
          </p>
        </div>
      </div>
    </div>
...
<?php /**PATH D:\VG\VechicleGuardian\InventoryManagement\resources\views/includes/login-form.blade.php ENDPATH**/ ?>