                                                ...
                                                <table class="datatable-init table dataTable-table"
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td class="tb-col"><?php echo e($item->sales_id); ?></td>
                                                                <td class="tb-col"><?php echo e($item->item->item_name); ?></td>
                                                                <td class="tb-col"><?php echo e($item->quantity_sold); ?></td>
                                                                <td class="tb-col"><?php echo e($item->total_price); ?></td>
                                                                <td class="tb-col"><?php echo e($item->sold_at); ?></td>
                                                                <td class="tb-col tb-col-end">
                                                                    <div class="d-flex justify-content-end gap g-2">
                                                                        <div class="gap-col"><a type="button"
                                                                                ...
                                                                                title="Print"
                                                                                href="<?php echo e(route('sales.edit', ['id' => $item->sales_id])); ?>"><em
                                                                                    class="icon ni ni-edit"></em></a>
                                                                        </div>
                                                                        <div class="gap-col"><a
                                                                                href="<?php echo e(route('sales.show', ['id' => $item->sales_id])); ?>"
                                                                        ...
                                                                        <div class="gap-col">
                                                                            <a href="#" id="delete-item"
                                                                                ...
                                                                                data-item-id="<?php echo e($item->sales_id); ?>">
...
<?php echo $__env->make('repairpartseller.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\VG\VechicleGuardian\InventoryManagement\resources\views/repairpartseller/sales/manage.blade.php ENDPATH**/ ?>