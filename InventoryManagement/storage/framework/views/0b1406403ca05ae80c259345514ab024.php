            ...
            <div class="nk-sidebar-menu" data-simplebar>
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item">
                        <a href="<?php echo e(route('repaircenter_dashboard', ['user' => auth()->user()->seller_uuid])); ?>" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-dashboard"></em></span>
                            <span class="nk-menu-text">Dashboard</span>
                        </a>
                    </li>
                    <li class="nk-menu-item">
                        <a href="<?php echo e(route("crud_index")); ?>" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-dashboard"></em></span>
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item"><a href="<?php echo e(route('repairpartseller.inventories.inventories.index')); ?>" class="nk-menu-link"><span
                            ...
                            <li class="nk-menu-item"><a href="<?php echo e(route('inventories.lowstock',['selleruuid' => auth()->user()->seller_uuid])); ?>" class="nk-menu-link"><span
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item"><a href="<?php echo e(route('repairpartseller.sales.create')); ?>" class="nk-menu-link"><span
                                        class="nk-menu-text">New Sale</span></a></li>
                            <li class="nk-menu-item"><a href="<?php echo e(route('sales.manage')); ?>" class="nk-menu-link"><span
...
<?php /**PATH D:\VG\VechicleGuardian\InventoryManagement\resources\views/repairpartseller/includes/sidebar.blade.php ENDPATH**/ ?>