                ...
                <div class="card-body">
                    ...
                    <div class="row g-2">
                        <div class="col-sm-6"><a href="#" class="btn btn-outline-light w-100"><img
                                    src="<?php echo e(asset('assets/images/icon/d.png')); ?>" alt="" class="icon"><span
                                    class="fw-medium">With Google</span></a></div>
                        <div class="col-sm-6"><a href="#" class="btn btn-outline-light w-100"><img
                                    src="<?php echo e(asset('assets/images/icon/b.png')); ?>" alt="" class="icon"><span
                                    class="fw-medium">With Facebook</span></a></div>
                    </div>
                </div>
            </div>
            <div class="text-center mt-5">
                <p class="small">Already have an account? <a href="<?php echo e(route('main.login')); ?>">Login</a></p>
            </div>
        </div>
    </div>
</div>
<?php /**PATH D:\VG\VechicleGuardian\InventoryManagement\resources\views/includes/register-form.blade.php ENDPATH**/ ?>