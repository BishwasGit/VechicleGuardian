<div class="nk-sidebar nk-sidebar-fixed is-theme" id="sidebar">
    <div class="nk-sidebar-element nk-sidebar-head">
        <div class="nk-sidebar-brand"><a href="index-2.html" class="logo-link">
                <div class="logo-wrap"><svg class="logo-svg" viewBox="0 0 174 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g class="logo-text">
...
<li class="nk-menu-item has-sub">
    ...
    <ul class="nk-menu-sub">
        <li class="nk-menu-item"><a href="inventory/add-item.html" class="nk-menu-link"><span class="nk-menu-text">Add Item</span></a></li>
        <li class="nk-menu-item"><a href="inventory/manage-items.html" class="nk-menu-link"><span class="nk-menu-text">Manage Items</span></a></li>
        <li class="nk-menu-item"><a href="inventory/low-stock.html" class="nk-menu-link"><span class="nk-menu-text">Low Stock</span></a></li>
    </ul>
</li>
...
<li class="nk-menu-item has-sub">
    ...
    <ul class="nk-menu-sub">
        <li class="nk-menu-item"><a href="sales/new-sale.html" class="nk-menu-link"><span class="nk-menu-text">New Sale</span></a></li>
        <li class="nk-menu-item"><a href="sales/manage-sales.html" class="nk-menu-link"><span class="nk-menu-text">Manage Sales</span></a></li>
    </ul>
</li>
...
<li class="nk-menu-item has-sub">
    ...
    <ul class="nk-menu-sub">
        <li class="nk-menu-item"><a href="purchases/new-purchase.html" class="nk-menu-link"><span class="nk-menu-text">New Purchase</span></a></li>
        <li class="nk-menu-item"><a href="purchases/manage-purchases.html" class="nk-menu-link"><span class="nk-menu-text">Manage Purchases</span></a></li>
    </ul>
</li>
...
<li class="nk-menu-item has-sub">
    ...
    <ul class="nk-menu-sub">
        <li class="nk-menu-item"><a href="debtors/add-debtor.html" class="nk-menu-link"><span class="nk-menu-text">Add Debtor</span></a></li>
        <li class="nk-menu-item"><a href="debtors/manage-debtors.html" class="nk-menu-link"><span class="nk-menu-text">Manage Debtors</span></a></li>
    </ul>
</li>
...
<li class="nk-menu-item has-sub">
    ...
    <ul class="nk-menu-sub">
        <li class="nk-menu-item"><a href="creditors/add-creditor.html" class="nk-menu-link"><span class="nk-menu-text">Add Creditor</span></a></li>
        <li class="nk-menu-item"><a href="creditors/manage-creditors.html" class="nk-menu-link"><span class="nk-menu-text">Manage Creditors</span></a></li>
    </ul>
</li>
...
<li class="nk-menu-item has-sub">
    ...
    <ul class="nk-menu-sub">
        <li class="nk-menu-item"><a href="reports/inventory-report.html" class="nk-menu-link"><span class="nk-menu-text">Inventory Report</span></a></li>
        <li class="nk-menu-item"><a href="reports/sales-report.html" class="nk-menu-link"><span class="nk-menu-text">Sales Report</span></a></li>
        <li class="nk-menu-item"><a href="reports/purchase-report.html" class="nk-menu-link"><span class="nk-menu-text">Purchase Report</span></a></li>
        <li class="nk-menu-item"><a href="reports/financial-report.html" class="nk-menu-link"><span class="nk-menu-text">Financial Report</span></a></li>
    </ul>
</li>
...
<li class="nk-menu-item has-sub">
    ...
    <ul class="nk-menu-sub">
        <li class="nk-menu-item"><a href="settings/general-settings.html" class="nk-menu-link"><span class="nk-menu-text">General Settings</span></a></li>
        <li class="nk-menu-item"><a href="settings/user-management.html" class="nk-menu-link"><span class="nk-menu-text">User Management</span></a></li>
    </ul>
</li>
