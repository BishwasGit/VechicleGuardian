                ...
                <div class="nk-content">
                    <div class="container-fluid">
                        <div class="nk-content-inner">
                            ...
                            <div class="nk-block">
                                <form action="{{ route('repairpartseller.inventories.inventories.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row g-gs">
                                        <div class="col-xxl-9">
                                            <div class="gap gy-4">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        <label for="item_description"
                                                                            class="form-label">Item_description</label>
                                                                        <div class="form-control-wrap">
                                                                            <input type="text" class="form-control"
                                                                                id="item_description"
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        <label for="item_price"
                                                                            class="form-label">Price Per Unit</label>
                                                                        <div class="form-control-wrap">
                                                                            <input type="text" class="form-control"
