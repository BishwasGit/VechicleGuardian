...
const RepairCenterDashboard = ({ route }) => {
  ...
  const handleAddDetails = async () => {
    const validateCoordinates = coordinates => {
      ...
      const coordinatePattern =
        /^-?([1-8]?[1-9]|[1-9]0)\.{1}\d{1,6},\s*-?([1]?[0-7]?[0-9]|[1-9]?[0-9])\.{1}\d{1,6}$/
  ...
  const handleAvailabilityScreen = screen =>{
    navigation.navigate('RepairCenterAvailabilityScreen',  { repaircenter_id })
  }

  const handleRepairHistory = screen  => {
  ...
  return (
    <ScrollView style={styles.MainContainer}>
      <View style={{ marginTop: 60 }}>
        ...
        >
          Hello,&nbsp;{repairCenterDetails && repairCenterDetails[0].username}
        </Text>
        <Text style={{ marginLeft: 2, marginBottom: 15, fontSize: 14 }}>
          Lets explore.
        </Text>
      </View>
      ...
      <View>
        ...
        <View style={styles.scrollContainer}>
          <View style={styles.gridContainer}>
            ...
            >
              <Ionicons name='time' size={25} color='#808000' />
              <Text style={styles.buttonText}>
                Manage Repair Center Availability
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.button}
    ...
    <View style={styles.profileContainer}>
      ...
      <View style={styles.switchprofilebutton}>
        {customerProfile && (
          ...
          >
            <Text style={styles.buttonProfileText}>
