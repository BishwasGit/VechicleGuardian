  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollViewContent}>
      <View style={styles.container}>
        ...
        <MyCalendar />
        <Card.Title
          title={<Text>Nearby Repair Centers</Text>}
          style={styles.title}
        />
        ...
        <Card style={styles.card}>
          <Card.Title
            title={<Text>Appointment Schedule</Text>}
            style={styles.title}
          />
          {upcomingAppointments.map(appointment => (
            ...
            >
              <List.Item
                title={<Text>{`Customer: ${appointment.customer}`}</Text>}
              />
            </List.Accordion>
          ))}
        </Card>
        ...
        <Card style={styles.card}>
          <Card.Title
            title={<Text>Repair Center Information</Text>}
            style={styles.title}
          />
          <List.Section>
            <List.Item
              title={<Text>Contact: 123-456-7890</Text>}
              left={props => <List.Icon {...props} icon='phone' />}
            />
            <List.Item
              title={<Text>Address: 123 Main St, City</Text>}
