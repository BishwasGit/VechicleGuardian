                                ...
                                <div class="nk-block-head">
                                    <div class="nk-block-head-between flex-wrap gap g-2">
                                        ...
                                        <div class="nk-block-head-content">
                                            <ul class="d-flex">
                                                <li>
                                                    <a href="{{ route('repairpartseller.creditors.create') }}"
                                                ...
                                                <li>
                                                    <a href="{{ route('repairpartseller.creditors.create') }}"
                                                        ...
                                                        <em class="icon ni ni-plus"></em><span>Add creditors</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="nk-block">
                                    <div class="card">
                                            ...
                                            <tr>
                                                <th class="tb-col" data-sortable="" style="width: 30.1887%;">
                                                    <a href="#" class="dataTable-sorter">
                                                        <span class="overline-title">Creditors Id</span>
                                                    </a>
                                                </th>
                                                <th class="tb-col" data-sortable="" style="width: 30.1887%;">
                                                    <a href="#" class="dataTable-sorter">
                                                        <span class="overline-title">Creditors Name</span>
                                                    </a>
                                                </th>
                                                <th class="tb-col" data-sortable="" style="width: 30.1887%;">
                                                    <a href="#" class="dataTable-sorter">
                                                        <span class="overline-title">Creditors Contact</span>
                                                    </a>
                                                </th>
                                                <th class="tb-col" data-sortable="" style="width: 30.1887%;">
                                                    <a href="#" class="dataTable-sorter">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="tb-col">{{ $item->creditor_id }}</td>
                                                <td class="tb-col">{{ $item->creditor_name }}</td>
                                                <td class="tb-col">{{ $item->creditor_contact }}</td>
                                                <td class="tb-col">{{ $item->amount_due }}</td>
                                                <td class="tb-col tb-col-end">
                                                    <div class="d-flex justify-content-end gap g-2">
                                                        <div class="gap-col">
                                                            <a href="#" id="delete-creditor"
                                                                class="btn btn-sm bg-danger-soft delete-creditor"
        ...
        $('.delete-creditor').on('click', function(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'DELETE',
                        url: "{{ route('repairpartseller.creditors.delete', ':id') }}"
